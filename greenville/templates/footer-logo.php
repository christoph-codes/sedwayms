		...
		<div class="footer_logo_wrap">
			<div class="footer_logo_inner">
				...
				if (!empty($greenville_logo_image)) {
					...
					echo '<a href="'.esc_url(home_url('/')).'"><img src="'.esc_url($greenville_logo_image).'" class="logo_footer_image" alt="'.esc_attr($alt).'"'.(!empty($greenville_attr[3]) ? sprintf(' %s', $greenville_attr[3]) : '').'></a>' ;
