						...
						?><div class="sc_layouts_title_title"><?php
							...
							<h1 class="sc_layouts_title_caption<?php echo esc_attr($greenville_blog_title_class); ?>"><?php
								...
								if (!empty($greenville_top_icon)) {
									...
									?><img src="<?php echo esc_url($greenville_top_icon); ?>" alt="<?php echo esc_attr($alt); ?>" <?php if (!empty($greenville_attr[3])) greenville_show_layout($greenville_attr[3]);?>><?php
								}
								echo wp_kses($greenville_blog_title_text, 'greenville_kses_content');
							?></h1>
							<?php
