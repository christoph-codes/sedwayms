	...
	function greenville_trx_addons_frontend_scripts() {
		if (greenville_exists_trx_addons()) {
			if (greenville_is_on(greenville_get_theme_option('debug_mode')) && greenville_get_file_dir('plugins/trx_addons/trx_addons.css')!='') {
				wp_enqueue_style( 'greenville-trx-addons',  greenville_get_file_url('plugins/trx_addons/trx_addons.css'), array(), null );
				wp_enqueue_style( 'greenville-trx-addons-editor',  greenville_get_file_url('plugins/trx_addons/trx_addons.editor.css'), array(), null );
			}
			if (greenville_is_on(greenville_get_theme_option('debug_mode')) && greenville_get_file_dir('plugins/trx_addons/trx_addons.js')!='')
				wp_enqueue_script( 'greenville-trx-addons', greenville_get_file_url('plugins/trx_addons/trx_addons.js'), array('jquery'), null, true );
		} else {
