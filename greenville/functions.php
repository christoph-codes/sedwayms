...
if ( !function_exists( 'greenville_wp_scripts' ) ) {
	...
	function greenville_wp_scripts() {
		...
		wp_enqueue_style( 'fontello-icons',  greenville_get_file_url('css/fontello/css/fontello-embedded.css') );
...
if ( !function_exists('greenville_add_body_classes') ) {
	...
	function greenville_add_body_classes( $classes ) {
		...
		$classes[] = 'trx_addons_' . esc_attr( greenville_exists_trx_addons() ? 'present' : 'absent' );
...
if ( !function_exists('greenville_theme_fonts_links') ) {
	function greenville_theme_fonts_links() {
		...
		*/
		$google_fonts_enabled = ( 'off' !== esc_html_x( 'on', 'Google fonts: on or off', 'greenville' ) );
		$custom_fonts_enabled = ( 'off' !== esc_html_x( 'on', 'Custom fonts (included in the theme): on or off', 'greenville' ) );
